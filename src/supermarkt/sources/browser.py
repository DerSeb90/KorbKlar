...
def chromium_command() -> str:
    ...
    # SUPERMARKT_CHROMIUM_BINARY is the older documented spelling and still
    # sits in deployed .env files, so it keeps working.
    for name in ("SUPERMARKT_CHROMIUM", "SUPERMARKT_CHROMIUM_BINARY"):
